  ...
  1 => 'nom',
    ...
    const entityDef = [
        ...
        'typeue' => [
            ...
            'targetEntity' => '\service\Model\TypeUE',
            'mappedBy' => 'typeue',
        ...
        'payeur' => [
            'type' => Field::ONETOMANY, 
            'targetEntity' => '\service\Model\Payeur',
            'mappedBy' => 'payeur',
            'inversedBy' => 'enseignementList',
            'twigName' => 'payeur',
            'dbName' => 'payeur', 
        ...
        'enseignement_besoins' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\service\Model\enseignement_besoins',
        ...
        'enseignement_periode' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\service\Model\enseignement_periode',
        ...
        'enseignement_structure' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\service\Model\enseignement_structure',
        ...
        'enseignement_etudiant_details' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\service\Model\enseignement_etudiant_details',
        ...
        'voeu_enseignement_bilan' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\service\Model\voeu_enseignement_bilan',
        ...
        'voeu_enseignement_bilan_prioritaire' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\service\Model\voeu_enseignement_bilan_prioritaire',
...
trait _Enseignement_ {
    ...
    protected ?\service\Model\TypeUE $typeue;
    protected int $__typeue;
    protected ?\service\Model\Payeur $payeur;
    protected int $__payeur;
    protected ?\service\Model\enseignement_besoins $enseignement_besoins;
    protected ?\service\Model\enseignement_periode $enseignement_periode;
    protected ?\service\Model\enseignement_structure $enseignement_structure;
    protected ?\service\Model\enseignement_etudiant_details $enseignement_etudiant_details;
    protected ?\service\Model\voeu_enseignement_bilan $voeu_enseignement_bilan;
    protected ?\service\Model\voeu_enseignement_bilan_prioritaire $voeu_enseignement_bilan_prioritaire;
