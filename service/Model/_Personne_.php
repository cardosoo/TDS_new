  ...
  0 => 'nom',
    ...
    const entityDef = [
        ...
        'statut' => [
            ...
            'targetEntity' => '\service\Model\Statut',
            'mappedBy' => 'statut',
        ...
        'situation' => [
            'type' => Field::ONETOMANY, 
            'targetEntity' => '\service\Model\Situation',
            'mappedBy' => 'situation',
            'inversedBy' => 'personneList',
            'twigName' => 'situation',
            'dbName' => 'situation', 
        ...
        'labo' => [
            'type' => Field::ONETOMANY, 
            'targetEntity' => '\service\Model\Labo',
            'mappedBy' => 'labo',
            'inversedBy' => 'personneList',
            'twigName' => 'labo',
            'dbName' => 'labo', 
        ...
        'voeu_personne_bilan' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\service\Model\voeu_personne_bilan',
        ...
        'personne_charge' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\service\Model\personne_charge',
        ...
        'personne_situation_reduction' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\service\Model\personne_situation_reduction',
        ...
        'personne_referentiel_heures' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\service\Model\personne_referentiel_heures',
        ...
        'voeuList' =>[ 
            'type' => Field::MANYTOMANY,
            'targetEntity' => '\service\Model\Enseignement',
            'joinTable' => '\service\Model\Voeu',
            'joinColumn' => 'personne',
            'twigName' => 'personne',
        ...
        'personne_etapeList' => [
            'type' => Field::MANYTOONE, 
            'sourceEntity' => '\service\Model\personne_etape',
            'mappedBy' => 'personne',
        ...
        'commentaire_personneList' =>[ 
            ...
            'joinTable' => '\service\Model\commentaire_personne',
            'joinColumn' => 'personne',
            'twigName' => 'personne',
        ...
        'commentaire_enseignementList' =>[ 
            'type' => Field::MANYTOMANY,
            'targetEntity' => '\service\Model\Enseignement',
            'joinTable' => '\service\Model\commentaire_enseignement',
            'joinColumn' => 'auteur',
            'twigName' => 'auteur',
        ...
        'commentaire_maquetteList' =>[ 
            'type' => Field::MANYTOMANY,
            'targetEntity' => '\service\Model\Maquette',
            'joinTable' => '\service\Model\commentaire_maquette',
            'joinColumn' => 'auteur',
            'twigName' => 'auteur',
        ...
        'commentaire_composanteList' =>[ 
            'type' => Field::MANYTOMANY,
            'targetEntity' => '\service\Model\Composante',
        ...
        'personne_foncrefList' =>[ 
            'type' => Field::MANYTOMANY,
            'targetEntity' => '\service\Model\FoncRef',
...
trait _Personne_ {
    ...
    protected ?\service\Model\Statut $statut;
    protected int $__statut;
    protected ?\service\Model\Situation $situation;
    protected int $__situation;
    protected ?\service\Model\Labo $labo;
    protected int $__labo;
    protected ?\service\Model\voeu_personne_bilan $voeu_personne_bilan;
    protected ?\service\Model\personne_charge $personne_charge;
    protected ?\service\Model\personne_situation_reduction $personne_situation_reduction;
    protected ?\service\Model\personne_referentiel_heures $personne_referentiel_heures;
