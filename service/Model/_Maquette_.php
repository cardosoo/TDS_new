  ...
  0 => 'ordre',
    ...
    const entityDef = [
        ...
        'diplomeList' => [
            ...
            'sourceEntity' => '\service\Model\Diplome',
            'mappedBy' => 'maquette',
...
trait _Maquette_ {
    ...
    protected ?\service\Model\Personne $gestionnaire;
    protected int $__gestionnaire;
    protected ?\service\Model\Personne $responsable;
    protected int $__responsable;
    protected ?\service\Model\Personne $co_responsable;
    protected int $__co_responsable;
    protected ?\service\Model\Composante $composante;
