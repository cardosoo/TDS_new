  ...
  0 => 'ordre',
    ...
    const entityDef = [
        ...
        'diplome' => [
            ...
            'targetEntity' => '\services\Model\Diplome',
            'mappedBy' => 'diplome',
        ...
        'cursus' => [
            'type' => Field::ONETOMANY, 
            'targetEntity' => '\services\Model\Cursus',
            'mappedBy' => 'cursus',
            'inversedBy' => 'etapeList',
            'twigName' => 'cursus',
            'dbName' => 'cursus', 
        ...
        'semestreList' => [
            ...
            'sourceEntity' => '\services\Model\Semestre',
            'mappedBy' => 'etape',
...
trait _Etape_ {
    ...
    protected ?\services\Model\Diplome $diplome;
    protected int $__diplome;
    protected ?\services\Model\Cursus $cursus;
