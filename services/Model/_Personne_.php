  ...
  0 => 'nom',
    ...
    const entityDef = [
        ...
        'statut' => [
            ...
            'targetEntity' => '\services\Model\Statut',
            'mappedBy' => 'statut',
        ...
        'situation' => [
            'type' => Field::ONETOMANY, 
            'targetEntity' => '\services\Model\Situation',
            'mappedBy' => 'situation',
            'inversedBy' => 'personneList',
            'twigName' => 'situation',
            'dbName' => 'situation', 
        ...
        'labo' => [
            'type' => Field::ONETOMANY, 
            'targetEntity' => '\services\Model\Labo',
            'mappedBy' => 'labo',
            'inversedBy' => 'personneList',
            'twigName' => 'labo',
            'dbName' => 'labo', 
        ...
        'voeu_personne_bilan' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\services\Model\voeu_personne_bilan',
        ...
        'personne_charge' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\services\Model\personne_charge',
        ...
        'personne_situation_reduction' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\services\Model\personne_situation_reduction',
        ...
        'personne_referentiel_heures' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\services\Model\personne_referentiel_heures',
        ...
        'actasList' =>[ 
            ...
            'joinTable' => '\services\Model\actAs',
            'joinColumn' => 'personne',
            'twigName' => 'personne',
        ...
        'maquetteList' => [
            ...
            'sourceEntity' => '\services\Model\Maquette',
        ...
        'responsableList' =>[ 
            ...
            'joinTable' => '\services\Model\responsable',
            'joinColumn' => 'personne',
            'twigName' => 'personne',
        ...
        'personne_etapeList' => [
            'type' => Field::MANYTOONE, 
            'sourceEntity' => '\services\Model\personne_etape',
            'mappedBy' => 'personne',
        ...
        'commentaire_personneList' =>[ 
            ...
            'joinTable' => '\services\Model\commentaire_personne',
            'joinColumn' => 'personne',
            'twigName' => 'personne',
        ...
        'commentaire_maquetteList' =>[ 
            'type' => Field::MANYTOMANY,
            'targetEntity' => '\services\Model\Maquette',
        ...
        'commentaire_composanteList' =>[ 
            ...
            'joinTable' => '\services\Model\commentaire_composante',
            'joinColumn' => 'auteur',
            'twigName' => 'auteur',
        ...
        'personne_situationList' =>[ 
            'type' => Field::MANYTOMANY,
            'targetEntity' => '\services\Model\Situation',
            'joinTable' => '\services\Model\personne_situation',
            'joinColumn' => 'personne',
            'twigName' => 'personne',
        ...
        'personne_foncrefList' =>[ 
            'type' => Field::MANYTOMANY,
            'targetEntity' => '\services\Model\FoncRef',
...
trait _Personne_ {
    ...
    protected ?\services\Model\Statut $statut;
    protected int $__statut;
    protected ?\services\Model\Situation $situation;
    protected int $__situation;
    protected ?\services\Model\Labo $labo;
    protected int $__labo;
    protected ?\services\Model\voeu_personne_bilan $voeu_personne_bilan;
    protected ?\services\Model\personne_charge $personne_charge;
    protected ?\services\Model\personne_situation_reduction $personne_situation_reduction;
    protected ?\services\Model\personne_referentiel_heures $personne_referentiel_heures;
