  ...
  1 => 'nom',
    ...
    const entityDef = [
        ...
        'typeue' => [
            ...
            'targetEntity' => '\services\Model\TypeUE',
            'mappedBy' => 'typeue',
        ...
        'payeur' => [
            'type' => Field::ONETOMANY, 
            'targetEntity' => '\services\Model\Payeur',
            'mappedBy' => 'payeur',
            'inversedBy' => 'enseignementList',
            'twigName' => 'payeur',
            'dbName' => 'payeur', 
        ...
        'enseignement_besoins' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\services\Model\enseignement_besoins',
        ...
        'enseignement_periode' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\services\Model\enseignement_periode',
        ...
        'enseignement_structure' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\services\Model\enseignement_structure',
        ...
        'enseignement_etudiant_details' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\services\Model\enseignement_etudiant_details',
        ...
        'voeu_enseignement_bilan' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\services\Model\voeu_enseignement_bilan',
        ...
        'voeu_enseignement_bilan_prioritaire' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\services\Model\voeu_enseignement_bilan_prioritaire',
        ...
        'ecueList' => [
            ...
            'sourceEntity' => '\services\Model\ECUE',
        ...
        'commentaire_enseignementList' =>[ 
            'type' => Field::MANYTOMANY,
            'targetEntity' => '\services\Model\Personne',
            'joinTable' => '\services\Model\commentaire_enseignement',
            'joinColumn' => 'enseignement',
            'twigName' => 'enseignement',
        ...
        'Heritage_Enfants' =>[ 
            ...
            'joinTable' => '\services\Model\Heritage',
            'joinColumn' => 'parent',
            'twigName' => 'enfants',
            'inverseJoinColum' => 'Heritage_Enfants',
            'isFirst' => true,
        ],
        ...
        'Heritage_Parents' =>[ 
            ...
            'joinColumn' => 'enfant',
            'twigName' => 'parents',
            'inverseJoinColum' => 'Heritage_Parents',
            'isFirst' => false,
        ],
        ...
        'panierList' =>[ 
            'type' => Field::MANYTOMANY,
            'targetEntity' => '\services\Model\Personne',
            'joinTable' => '\services\Model\Panier',
            'joinColumn' => 'enseignement',
            'twigName' => 'enseignement',
...
trait _Enseignement_ {
    ...
    protected ?\services\Model\TypeUE $typeue;
    protected int $__typeue;
    protected ?\services\Model\Payeur $payeur;
    protected int $__payeur;
    protected ?\services\Model\enseignement_besoins $enseignement_besoins;
    protected ?\services\Model\enseignement_periode $enseignement_periode;
    protected ?\services\Model\enseignement_structure $enseignement_structure;
    protected ?\services\Model\enseignement_etudiant_details $enseignement_etudiant_details;
    protected ?\services\Model\voeu_enseignement_bilan $voeu_enseignement_bilan;
    protected ?\services\Model\voeu_enseignement_bilan_prioritaire $voeu_enseignement_bilan_prioritaire;
    ...
    protected array $Heritage_Enfants;
    protected array $Heritage_Parents;
