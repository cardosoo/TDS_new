...
if ($year == '2025'){
    App::$texte = [
        ...
        'debutVoeux' => 'lundi 26/01/2026',
        'limiteVoeux' => 'dimanche 1/06/2026',
        'debutDiagonalisation' => 'lundi 2/06/2026',
        'finDiagonalisation' => 'lundi 9/06/2026',
        'dateFoire' => 'mardi 10 juin 2026',
    ...
    $finPanier = DateTime::createFromFormat('Y-m-d H:i:s', '2026-01-25 07:59:59');
