  ...
  0 => 'nom',
    ...
    const entityDef = [
        ...
        'statut' => [
            ...
            'targetEntity' => '\base\Model\Statut',
            'mappedBy' => 'statut',
        ...
        'situation' => [
            'type' => Field::ONETOMANY, 
            'targetEntity' => '\base\Model\Situation',
            'mappedBy' => 'situation',
            'inversedBy' => 'personneList',
            'twigName' => 'situation',
            'dbName' => 'situation', 
        ...
        'voeu_personne_bilan' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\base\Model\voeu_personne_bilan',
        ...
        'personne_charge' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\base\Model\personne_charge',
        ...
        'personne_situation_reduction' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\base\Model\personne_situation_reduction',
        ...
        'personne_referentiel_heures' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\base\Model\personne_referentiel_heures',
        ...
        'actasList' =>[ 
            ...
            'targetEntity' => '\base\Model\Role',
            'joinTable' => '\base\Model\actAs',
            'joinColumn' => 'personne',
            'twigName' => 'personne',
        ...
        'personne_etapeList' => [
            'type' => Field::MANYTOONE, 
            'sourceEntity' => '\base\Model\personne_etape',
            'mappedBy' => 'personne',
        ...
        'commentaire_personneList' =>[ 
            ...
            'joinTable' => '\base\Model\commentaire_personne',
            'joinColumn' => 'personne',
            'twigName' => 'personne',
        ...
        'personne_situationList' =>[ 
            'type' => Field::MANYTOMANY,
            'targetEntity' => '\base\Model\Situation',
            'joinTable' => '\base\Model\personne_situation',
            'joinColumn' => 'personne',
            'twigName' => 'personne',
        ...
        'personne_foncrefList' =>[ 
            'type' => Field::MANYTOMANY,
            'targetEntity' => '\base\Model\FoncRef',
            'joinTable' => '\base\Model\personne_foncRef',
            'joinColumn' => 'personne',
            'twigName' => 'personne',
...
trait _Personne_ {
    ...
    protected ?\base\Model\Statut $statut;
    protected int $__statut;
    protected ?\base\Model\Situation $situation;
    protected int $__situation;
    protected ?\base\Model\Labo $labo;
    protected int $__labo;
    protected ?\base\Model\voeu_personne_bilan $voeu_personne_bilan;
    protected ?\base\Model\personne_charge $personne_charge;
    protected ?\base\Model\personne_situation_reduction $personne_situation_reduction;
    protected ?\base\Model\personne_referentiel_heures $personne_referentiel_heures;
