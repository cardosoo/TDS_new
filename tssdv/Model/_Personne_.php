  ...
  0 => 'nom',
    ...
    const entityDef = [
        ...
        'statut' => [
            ...
            'targetEntity' => '\tssdv\Model\Statut',
            'mappedBy' => 'statut',
        ...
        'situation' => [
            'type' => Field::ONETOMANY, 
            'targetEntity' => '\tssdv\Model\Situation',
            'mappedBy' => 'situation',
            'inversedBy' => 'personneList',
            'twigName' => 'situation',
            'dbName' => 'situation', 
        ...
        'voeu_personne_bilan' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\tssdv\Model\voeu_personne_bilan',
        ...
        'personne_charge' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\tssdv\Model\personne_charge',
        ...
        'personne_situation_reduction' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\tssdv\Model\personne_situation_reduction',
        ...
        'personne_referentiel_heures' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\tssdv\Model\personne_referentiel_heures',
        ...
        'maquetteList' => [
            ...
            'sourceEntity' => '\tssdv\Model\Maquette',
        ...
        'responsableList' =>[ 
            ...
            'joinTable' => '\tssdv\Model\responsable',
            'joinColumn' => 'personne',
            'twigName' => 'personne',
        ...
        'personne_etapeList' => [
            'type' => Field::MANYTOONE, 
            'sourceEntity' => '\tssdv\Model\personne_etape',
            'mappedBy' => 'personne',
        ...
        'commentaire_personneList' =>[ 
            ...
            'joinTable' => '\tssdv\Model\commentaire_personne',
            'joinColumn' => 'personne',
            'twigName' => 'personne',
        ...
        'commentaire_maquetteList' =>[ 
            ...
            'joinTable' => '\tssdv\Model\commentaire_maquette',
            'joinColumn' => 'auteur',
            'twigName' => 'auteur',
        ...
        'commentaire_composanteList' =>[ 
            ...
            'joinTable' => '\tssdv\Model\commentaire_composante',
            'joinColumn' => 'auteur',
            'twigName' => 'auteur',
        ...
        'personne_foncrefList' =>[ 
            ...
            'joinTable' => '\tssdv\Model\personne_foncRef',
            'joinColumn' => 'personne',
            'twigName' => 'personne',
...
trait _Personne_ {
    ...
    protected ?\tssdv\Model\Statut $statut;
    protected int $__statut;
    protected ?\tssdv\Model\Situation $situation;
    protected int $__situation;
    protected ?\tssdv\Model\Labo $labo;
    protected int $__labo;
    protected bool $etat_ts = FALSE;
    protected ?\tssdv\Model\voeu_personne_bilan $voeu_personne_bilan;
    protected ?\tssdv\Model\personne_charge $personne_charge;
    protected ?\tssdv\Model\personne_situation_reduction $personne_situation_reduction;
    protected ?\tssdv\Model\personne_referentiel_heures $personne_referentiel_heures;
