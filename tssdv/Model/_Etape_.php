  ...
  0 => 'ordre',
    ...
    const entityDef = [
        ...
        'diplome' => [
            ...
            'targetEntity' => '\tssdv\Model\Diplome',
            'mappedBy' => 'diplome',
        ...
        'cursus' => [
            'type' => Field::ONETOMANY, 
            'targetEntity' => '\tssdv\Model\Cursus',
            'mappedBy' => 'cursus',
            'inversedBy' => 'etapeList',
            'twigName' => 'cursus',
            'dbName' => 'cursus', 
        ...
        'semestreList' => [
            ...
            'sourceEntity' => '\tssdv\Model\Semestre',
            'mappedBy' => 'etape',
...
trait _Etape_ {
    ...
    protected ?\tssdv\Model\Diplome $diplome;
    protected int $__diplome;
    protected ?\tssdv\Model\Cursus $cursus;
