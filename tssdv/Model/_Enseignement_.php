  ...
  1 => 'nom',
    ...
    const entityDef = [
        ...
        'typeue' => [
            ...
            'targetEntity' => '\tssdv\Model\TypeUE',
            'mappedBy' => 'typeue',
        ...
        'payeur' => [
            'type' => Field::ONETOMANY, 
            'targetEntity' => '\tssdv\Model\Payeur',
            'mappedBy' => 'payeur',
            'inversedBy' => 'enseignementList',
            'twigName' => 'payeur',
            'dbName' => 'payeur', 
        ...
        'enseignement_besoins' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\tssdv\Model\enseignement_besoins',
        ...
        'enseignement_periode' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\tssdv\Model\enseignement_periode',
        ...
        'enseignement_structure' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\tssdv\Model\enseignement_structure',
        ...
        'enseignement_etudiant_details' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\tssdv\Model\enseignement_etudiant_details',
        ...
        'voeu_enseignement_bilan' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\tssdv\Model\voeu_enseignement_bilan',
        ...
        'voeu_enseignement_bilan_prioritaire' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\tssdv\Model\voeu_enseignement_bilan_prioritaire',
        ...
        'enseignement_besoins_detail' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\tssdv\Model\enseignement_besoins_detail',
            'dbName' => 'enseignement_besoins_detail',
            'twigName' => 'enseignement_besoins_detail',
            'targetId' => 'id',
        ],    
        ...
        'commentaire_enseignementList' =>[ 
            'type' => Field::MANYTOMANY,
            'targetEntity' => '\tssdv\Model\Personne',
            'joinTable' => '\tssdv\Model\commentaire_enseignement',
            'joinColumn' => 'enseignement',
            'twigName' => 'enseignement',
...
trait _Enseignement_ {
    ...
    protected ?\tssdv\Model\TypeUE $typeue;
    protected int $__typeue;
    protected ?\tssdv\Model\Payeur $payeur;
    protected int $__payeur;
    protected bool $etat_ts = FALSE;
    protected ?\tssdv\Model\enseignement_besoins $enseignement_besoins;
    protected ?\tssdv\Model\enseignement_periode $enseignement_periode;
    protected ?\tssdv\Model\enseignement_structure $enseignement_structure;
    protected ?\tssdv\Model\enseignement_etudiant_details $enseignement_etudiant_details;
    protected ?\tssdv\Model\voeu_enseignement_bilan $voeu_enseignement_bilan;
    protected ?\tssdv\Model\voeu_enseignement_bilan_prioritaire $voeu_enseignement_bilan_prioritaire;
    protected ?\tssdv\Model\structure_enseignement $structure_enseignement;
    protected ?\tssdv\Model\enseignement_besoins_detail $enseignement_besoins_detail;
