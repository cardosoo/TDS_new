...
* filename : _voeu_enseignement_bilan_.php
* created : Mon, 06 Apr 2026 10:58:56 +0200 UTC
*/ 

interface _voeu_enseignement_bilan_interface_ {
    const dbName = 'voeu_enseignement_bilan';
    const idName = 'id';
    const SEARCH = NULL;
    const GENERIC = NULL;
    const ORDER = NULL;

    // les définitions de l'entité voeu_enseignement_bilan
    const entityDef = [
...
trait _voeu_enseignement_bilan_ {
    protected int $id;            
