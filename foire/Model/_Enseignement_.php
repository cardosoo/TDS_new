  ...
  1 => 'nom',
    ...
    const entityDef = [
        ...
        'typeue' => [
            ...
            'targetEntity' => '\foire\Model\TypeUE',
            'mappedBy' => 'typeue',
        ...
        'payeur' => [
            'type' => Field::ONETOMANY, 
            'targetEntity' => '\foire\Model\Payeur',
            'mappedBy' => 'payeur',
            'inversedBy' => 'enseignementList',
            'twigName' => 'payeur',
            'dbName' => 'payeur', 
        ...
        'enseignement_besoins' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\foire\Model\enseignement_besoins',
        ...
        'enseignement_periode' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\foire\Model\enseignement_periode',
        ...
        'enseignement_structure' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\foire\Model\enseignement_structure',
        ...
        'enseignement_etudiant_details' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\foire\Model\enseignement_etudiant_details',
        ...
        'voeu_enseignement_bilan' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\foire\Model\voeu_enseignement_bilan',
        ...
        'voeu_enseignement_bilan_prioritaire' => [
            'type' => Field::ONETOONE, 
            'targetEntity' => '\foire\Model\voeu_enseignement_bilan_prioritaire',
        ...
        'Heritage_Enfants' =>[ 
            ...
            'joinTable' => '\foire\Model\Heritage',
            'joinColumn' => 'parent',
            'twigName' => 'enfants',
...
trait _Enseignement_ {
    ...
    protected ?\foire\Model\TypeUE $typeue;
    protected int $__typeue;
    protected ?\foire\Model\Payeur $payeur;
    protected int $__payeur;
    protected ?\foire\Model\enseignement_besoins $enseignement_besoins;
    protected ?\foire\Model\enseignement_periode $enseignement_periode;
    protected ?\foire\Model\enseignement_structure $enseignement_structure;
    protected ?\foire\Model\enseignement_etudiant_details $enseignement_etudiant_details;
    protected ?\foire\Model\voeu_enseignement_bilan $voeu_enseignement_bilan;
    protected ?\foire\Model\voeu_enseignement_bilan_prioritaire $voeu_enseignement_bilan_prioritaire;
