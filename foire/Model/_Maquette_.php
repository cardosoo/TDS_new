  ...
  0 => 'ordre',
    ...
    const entityDef = [
        ...
        'diplomeList' => [
            ...
            'sourceEntity' => '\foire\Model\Diplome',
            'mappedBy' => 'maquette',
...
trait _Maquette_ {
    ...
    protected ?\foire\Model\Personne $gestionnaire;
    protected int $__gestionnaire;
    protected ?\foire\Model\Personne $responsable;
    protected int $__responsable;
    protected ?\foire\Model\Personne $co_responsable;
    protected int $__co_responsable;
    protected ?\foire\Model\Composante $composante;
